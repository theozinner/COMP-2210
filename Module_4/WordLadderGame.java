...
public interface WordLadderGame {
     ...
     */
    int getHammingDistance(String str1, String str2); //4
    ...
    */
    List<String> getMinLadder(String start, String end); //7
     ...
     */
    List<String> getNeighbors(String word); //5
     ...
     *                       false otherwise
     */
    boolean isWordLadder(List<String> sequence); //6
}
