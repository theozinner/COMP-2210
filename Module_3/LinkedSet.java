...
public class LinkedSet<T extends Comparable<? super T>> implements Set<T> {
   ...
   public boolean equals(LinkedSet<T> s) {
     ...
     *   2) First put parameter into linkedSet.
     *   3) Then iterate through the set to and add each element.
     *
   ...
   public Set<T> union(LinkedSet<T> s) {
     ...
     *   2) Check if an element is in either set and add.
     *   3) This method is linear M + N.
     *
   ...
   public Iterator<Set<T>> powerSetIterator() {  
    ...
    //////////////////////////////
   private int q = 0; //index of power set
